import { jobs } from "@/lib/db/schema/tables/content";
import {
  enumJobsPropertyType,
  enumStartDateFlag,
} from "@/lib/db/schema/tables/enums";
...
export const createJobInput = createInsertSchema(jobs, {
  ...
  startDateFlag: z
    ...
    .optional()
    .default("none"),
  propertyType: z.enum(enumJobsPropertyType.enumValues, {
...
export const updateJobInput = createInsertSchema(jobs, {
  ...
  startDateFlag: z
    ...
    .optional(),
  propertyType: z
    .enum(enumJobsPropertyType.enumValues, {
      required_error: "propertyType is required",
      invalid_type_error: "propertyType must be a valid enum value",
    })
    .optional(),
...
export const getJobsByIdsInput = z
  .object({
    ...
    propertyTypes: z
      .array(
        z.enum(enumJobsPropertyType.enumValues, {
          invalid_type_error: "Property types must be a valid enum value",
          required_error: "Property types cannot be empty if provided",
        }),
      )
      .max(enumJobsPropertyType.enumValues.length, {
        message: `You cannot provide more than ${enumJobsPropertyType.enumValues.length} property types`,
      })
      .optional(),
    startDateFlags: z
      .array(
