...
//   if (!data)
//     return (
//       <div className="relative h-screen  w-full bg-cover xl:bg-bottom">
//         <Skeleton className="absolute right-1/2 top-1/4 h-[80vh] w-[95vw] -translate-y-1/4 translate-x-1/2 sm:w-[min(80vw,1250px)]" />
//       </div>
//     );
...
//         className="absolute right-1/2  top-1/4 w-[95vw] -translate-y-1/4 translate-x-1/2 bg-background sm:w-[min(80vw,1250px)]"
//         scrollAreaProps={{
