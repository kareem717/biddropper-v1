...
CREATE TABLE `bids` (
	...
	`status` enum('pending','accepted','declined','retracted') NOT NULL DEFAULT 'pending',
	`created_at` timestamp DEFAULT CURRENT_TIMESTAMP,
	`updated_at` timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--> statement-breakpoint
CREATE TABLE `company_contracts_view` (
...
CREATE TABLE `company_industries` (
	...
	CONSTRAINT `company_industries_company_id_industry_id` PRIMARY KEY(`company_id`,`industry_id`)
);
--> statement-breakpoint
CREATE TABLE `company_jobs` (
	`company_id` varchar(50) NOT NULL,
	`job_id` varchar(50) NOT NULL,
	CONSTRAINT `company_jobs_company_id_job_id` PRIMARY KEY(`company_id`,`job_id`)
);
--> statement-breakpoint
CREATE TABLE `company_projects` (
	`company_id` varchar(50) NOT NULL,
	`project_id` varchar(50) NOT NULL,
	CONSTRAINT `company_projects_company_id_project_id` PRIMARY KEY(`company_id`,`project_id`)
);
--> statement-breakpoint
CREATE TABLE `contract_bids` (
	`bid_id` varchar(50) NOT NULL,
	`contract_id` varchar(50) NOT NULL,
	CONSTRAINT `contract_bids_bid_id_contract_id` PRIMARY KEY(`bid_id`,`contract_id`)
);
--> statement-breakpoint
CREATE TABLE `contract_jobs` (
	`contract_id` varchar(50) NOT NULL,
	`job_id` varchar(50) NOT NULL,
	CONSTRAINT `contract_jobs_contract_id_job_id` PRIMARY KEY(`contract_id`,`job_id`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `full_contract_view` (
	`contract_id` varchar(50) NOT NULL,
	`job_id` varchar(50) NOT NULL,
	`media_id` varchar(50)
);
--> statement-breakpoint
CREATE TABLE `full_job_view` (
	`job_id` varchar(50) NOT NULL,
	`media_id` varchar(50)
);
--> statement-breakpoint
CREATE TABLE `full_project_view` (
	`project_id` varchar(50) NOT NULL,
	`media_id` varchar(50)
);
--> statement-breakpoint
CREATE TABLE `full_review_view` (
...
CREATE TABLE `job_bids` (
	`bid_id` varchar(50) NOT NULL,
	`job_id` varchar(50) NOT NULL,
	CONSTRAINT `job_bids_bid_id_job_id` PRIMARY KEY(`bid_id`,`job_id`)
);
--> statement-breakpoint
CREATE TABLE `job_media` (
	`media_id` varchar(50) NOT NULL,
	`job_id` varchar(50) NOT NULL,
	CONSTRAINT `job_media_job_id_media_id` PRIMARY KEY(`job_id`,`media_id`)
);
--> statement-breakpoint
CREATE TABLE `jobs` (
	`id` varchar(50) NOT NULL,
...
CREATE TABLE `project_media` (
	`project_id` varchar(50) NOT NULL,
	`media_id` varchar(50) NOT NULL,
	CONSTRAINT `project_media_media_id_project_id` PRIMARY KEY(`media_id`,`project_id`)
);
--> statement-breakpoint
...
CREATE TABLE `review_media` (
	...
	`media_id` varchar(50) NOT NULL,
	CONSTRAINT `review_media_media_id_review_id` PRIMARY KEY(`media_id`,`review_id`)
);
--> statement-breakpoint
...
CREATE TABLE `user_jobs` (
	...
	CONSTRAINT `user_jobs_job_id_user_id` PRIMARY KEY(`job_id`,`user_id`)
);
--> statement-breakpoint
CREATE TABLE `users` (
