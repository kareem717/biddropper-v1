...
export default function AuthLayout({ children }: AuthLayoutProps) {
	return (
		<div className="gridclassName min-h-screen grid-cols-1 overflow-hidden md:grid-cols-3 lg:grid-cols-2">
			<AspectRatio ratio={16 / 9}>
				...
				<div className="flex lg:flex-1 absolute left-8 top-6 z-20">
